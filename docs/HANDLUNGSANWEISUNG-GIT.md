...
Auf GitHub: **Pull Request** `feature/…` → `master` auf **eigenem Fork** (`weiseb78/AmigaGPT` / `origin`). **Kein** PR gegen `sacredbanana/AmigaGPT` — weder durch Agent noch auf Nutzer-Anfrage.
