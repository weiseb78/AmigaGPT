...
description: Gettext translation updater for AmigaGPT. Use proactively whenever `catalogs/AmigaGPT.pot` changes or new strings are added, to merge updates into every `catalogs/*/*.po` file and translate only new or untranslated entries while preserving gettext formatting, placeholders, and existing human translations.
is_background: true
---
